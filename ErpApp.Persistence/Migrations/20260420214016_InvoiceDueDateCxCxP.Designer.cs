...
namespace ErpApp.Persistence.Migrations
{
    ...
    [Migration("20260420214016_InvoiceDueDateCxCxP")]
    partial class InvoiceDueDateCxCxP
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpApp.Domain.Entities.TreasuryAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErpApp.Domain.Entities.TreasuryMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CounterpartyTreasuryAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CounterpartyTreasuryAccountId");

                    b.HasIndex("TreasuryAccountId");

                    b.ToTable("TreasuryMovements");
                });
            ...
            modelBuilder.Entity("ErpApp.Domain.Entities.TreasuryMovement", b =>
                {
                    b.HasOne("ErpApp.Domain.Entities.TreasuryAccount", "CounterpartyTreasuryAccount")
                        .WithMany()
                        .HasForeignKey("CounterpartyTreasuryAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ErpApp.Domain.Entities.TreasuryAccount", "TreasuryAccount")
                        .WithMany()
                        .HasForeignKey("TreasuryAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CounterpartyTreasuryAccount");
